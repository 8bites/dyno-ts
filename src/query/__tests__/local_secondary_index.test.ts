...
class Card extends Table {
    ...
    public static readonly countIndex: Query.LocalSecondaryIndex<
        Card,
        number,
        number
    >;

    @Decorator.Writer() public static readonly writer: Query.Writer<Card>;
...
describe("LocalSecondaryIndex", () => {
    ...
    describe("#query", () => {
        it("should find items", async () => {
            ...
            expect(res.records[0].count).toBe(4);
            expect(res.records[1].count).toBe(3);
        });
    });
});
